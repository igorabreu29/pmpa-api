...
export async function activeManager(
  app: FastifyInstance
) {
  app
    .withTypeProvider<ZodTypeProvider>()
    .patch('/courses/:courseId/managers/:managerId/active-status', {
  ...
  async (req, res) => {
    ...
    makeOnManagerActivated()
    const useCase = makeActiveManagerCourseUseCase()
