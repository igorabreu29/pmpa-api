...
import { makeCreateCourseSubClassificationByManagerSheetUseCase } from "@/infra/factories/make-create-course-sub-classification-by-manager-sheet-use-case.ts";

export async function createSubClassificationByManagerSheet(
  app: FastifyInstance
) {
  app
    .withTypeProvider<ZodTypeProvider>()
    .post('/courses/:id/manager/classification/sheet/sub', {
      ...
      const useCase = makeCreateCourseSubClassificationByManagerSheetUseCase()
