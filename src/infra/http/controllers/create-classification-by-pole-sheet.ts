...
export async function createClassificationByPoleSheet(
  app: FastifyInstance
) {
  app
    .withTypeProvider<ZodTypeProvider>()
    .post('/courses/:courseId/poles/:poleId/classification/sheet', {
      ...
      const useCase = makeCreateCourseClassificationByPoleSheetUseCase()
