...
describe('Create Sub Classification By Manager Sheet (e2e)', () => {
  beforeAll(async () => {
  ...
  it ('POST /courses/:id/manager/classification/sheet/sub', async () => {
    ...
    const response = await request(app.server)
      .post(`/courses/${course.id.toValue()}/manager/classification/sheet?hasBehavior=true&disciplineModule=1`)
