...
import { makeChangeManagerAvatarUseCase } from "@/infra/factories/make-change-manager-avatar-use-case.ts";

export async function changeManagerAvatar(
  app: FastifyInstance
) {
  app
    .withTypeProvider<ZodTypeProvider>()
    .patch('/managers/avatar', {
