...
import { makeChangeDeveloperAvatarUseCase } from "@/infra/factories/make-change-developer-avatar-use-case.ts";

export async function changeDeveloperAvatar(
  app: FastifyInstance
) {
  app
  ...
  async (req, res) => {
    ...
    const useCase = makeChangeDeveloperAvatarUseCase()
