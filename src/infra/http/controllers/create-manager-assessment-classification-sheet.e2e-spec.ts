...
describe('Create Manager Assessment Classification Sheet (e2e)', () => {
  beforeAll(async () => {
  ...
  it ('POST /courses/:id/manager/classification/sheet', async () => {
    ...
    const response = await request(app.server)
      .post(`/courses/${course.id.toValue()}/manager/classification/assessments/sheet`)
