...
describe('Create Assessment Classification Sheet (e2e)', () => {
  beforeAll(async () => {
  ...
  it ('POST /courses/:id/classification/assessments/sheet', async () => {
    const { token } = await makeAuth()

    const response = await request(app.server)
      .post(`/courses/${course.id}/classification/assessments/sheet`)
