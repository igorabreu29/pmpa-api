...
import { OnStudentActivated } from './on-student-activated.ts'
...
describe('On Student Activated', () => {
  ...
  it ('should send a report when an student is created', async () => {
    ...
    const studentCourse = makeStudentCourse({ courseId: course.id, studentId: student.id, isActive: false })
