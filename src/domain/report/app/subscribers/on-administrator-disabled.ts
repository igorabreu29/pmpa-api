...
export class OnAdministratorDisabled implements EventHandler {
  constructor (
  ...
  setupSubscriptions(): void {
    DomainEvents.register(
      this.sendDisableAdministratorReport.bind(this),
      ChangeAdministratorStatusEvent.name
    )
  }

  private async sendDisableAdministratorReport({ administrator, reason, reporterId, reporterIp, ocurredAt }: ChangeAdministratorStatusEvent) {
