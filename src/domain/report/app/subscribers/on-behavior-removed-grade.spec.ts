...
import { OnBehaviorRemovedGrade } from './on-behavior-removed-grade.ts'
...
describe('On Behavior Removed Grade', () => {
  beforeEach(() => {
  ...
  it ('should send a report when an behavior grade is deleted', async () => {
