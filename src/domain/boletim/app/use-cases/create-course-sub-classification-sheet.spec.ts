...
import { makeGetCourseSubClassificationUseCase } from "test/factories/make-get-course-sub-classification-use-case.ts";
import { CreateCourseSubClassificationSheetUseCase } from "./create-course-sub-classification-sheet.ts";
...
let getCourseSubClassification: GetCourseSubClassificationUseCase
let sheeter: FakeSheeter
let sut: CreateCourseSubClassificationSheetUseCase

describe('Create Course Sub Classification Sheet', () => {
  beforeEach(() => {
    ...
    getCourseSubClassification = makeGetCourseSubClassificationUseCase({
      coursesRepository,
      studentCoursesRepository,
  ...
  it ('should be able to create course classification sheet', async () => {
    ...
    expect(result.value).toMatchObject({
      filename: `${course.name.value} - Sub Classificação Geral.xlsx`
    })
  })
})