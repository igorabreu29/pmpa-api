...
import { CreateCourseSubClassificationByManagerSheetUseCase } from "./create-course-sub-classification-by-manager-sheet.ts";
...
let sut: CreateCourseSubClassificationByManagerSheetUseCase

describe('Create Course Sub Classification By Manager Sheet', () => {
  beforeEach(() => {
