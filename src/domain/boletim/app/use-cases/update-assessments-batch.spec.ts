...
describe('Update Assessments Batch Use Case', () => {
  ...
  it ('should not be able to update assessments batch if user access is student', async () => {
  ...
  it ('should not be able to update assessments batch if course does not exist', async () => {
    const result = await sut.execute({
      studentAssessments: [], 
      courseId: 'not-found', 
      userIp: '', 
  ...
  it ('should not be able to update assessments batch if student does not exist.', async () => {
  ...
  it ('should not be able to update assessments batch if discipline does not exist', async () => {
    const course = makeCourse()
    coursesRepository.create(course)
  ...
  it ('should not be able to update assessments batch if the student does not has assessment', async () => {
    const course = makeCourse()
    coursesRepository.create(course)
  ...
  it ('should be able to update assessments batch', async () => {
    const course = makeCourse()
    coursesRepository.create(course)
