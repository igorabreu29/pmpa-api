...
describe('Create Behaviors Batch Use Case', () => {
  ...
  it ('should not be able to update behaviors batch if course does not exist', async () => {
    const result = await sut.execute({ 
      studentBehaviors: [], 
      courseId: 'not-found', 
      userIp: '', 
  ...
  it ('should not be able to update behaviors batch if student does not exist.', async () => {
