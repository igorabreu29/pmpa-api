...
let sut: SearchStudentsAndManagersDetailsManagerUseCase
...
describe('Search Students And Managers Details By Administrator', () => {
  beforeEach(() => {
    ...
    sut = new SearchStudentsAndManagersDetailsManagerUseCase(
  ...
  it ('should not be able to search students and managers if admin does not exist', async () => {
  ...
  it ('should be able to search students and managers', async () => {
