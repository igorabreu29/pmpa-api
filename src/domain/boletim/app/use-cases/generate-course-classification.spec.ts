...
let sut: GenerateCourseClassificationUseCase

describe('Generate Classfication Course Use Case', () => {
  beforeEach(() => {
    ...
    sut = new GenerateCourseClassificationUseCase(
      coursesRepository,
      studentsCoursesRepository,
  ...
  it ('should be able to get geral course classification', async () => {
    ...
    expect(classificationsRepository.items).toHaveLength(2)
  })
})