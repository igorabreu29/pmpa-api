...
import { FetchLoginConfirmationMetricsByManager } from "./fetch-login-confirmation-metrics-by-manager.ts";
...
let sut: FetchLoginConfirmationMetricsByManager
...
describe('Fetch Login Confirmation Metrics By Manager', () => {
  beforeEach(() => {
    ...
    sut = new FetchLoginConfirmationMetricsByManager(
      coursesRepository,
      managersCoursesRepository,
      studentsPolesRepository
    )
